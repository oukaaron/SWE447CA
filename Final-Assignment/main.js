var pointLight, sun, moon, earth, mercury, venus, mars, jupiter, saturn, uranus, neptune, pluto, earthOrbit, ring, controls, scene, camera, renderer, scene;
...
var mercuryData = constructPlanetData(87.67, 0.015, 18, "mercury", "img/mercury.jpg", 0.38, planetSegments);
var venusData = constructPlanetData(225, 0.015, 20, "venus", "img/venus.jpg", 0.95, planetSegments);
var marsData = constructPlanetData(687, 0.015, 30, "mars", "img/mars.jpg", 0.53, planetSegments);
var jupiterData = constructPlanetData(4380, 0.015, 100, "jupiter", "img/jupiter.jpg", 11.2, planetSegments);
var saturnData = constructPlanetData(10585, 0.015, 200, "saturn", "img/saturn.jpg", 9.45, planetSegments);
var uranusData = constructPlanetData(30660, 0.015, 250, "uranus", "img/uranus.jpg", 4, planetSegments);
var neptuneData = constructPlanetData(60225, 0.015, 300, "neptune", "img/neptune.jpg", 3.88, planetSegments);
var plutoData = constructPlanetData(90520, 0.015, 350, "pluto", "img/pluto.jpg", .38, planetSegments);
